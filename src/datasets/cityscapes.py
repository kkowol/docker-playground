...
labels = [
    ...
    Label(  'bus'                  , 28 ,      15       ,       'vehicle'         , 7       , True         , False        , (255, 102, 0)), #(  0, 60,100) ),
    ...
    Label(  'guardrail'            , 34 ,      19       ,       'construction'    , 2       , False        , False        , (255, 102, 0)),  # Neu in cs
